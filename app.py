...
By clicking `Play` on the map above, you will see a video of how the consumption of fish has developed from 1961 to 2017.
...
As representatives of each region, we observe in 2017, that Norway has a consumption of `51.35` kg pr capita and `China` had
...
These coastal nations often have a large economical incentive to supply this demand, since they rely on 
...
such as exporting seafood to the world's Other countries. For developed countries or relatively wealthy countries, 
...
farming and importing seafood. No matter from which point of view, it will lead to increasing demand for seafood in the world. 
...
To alleviate the supply gap caused by the shortage of seafood resources, many countries in the world have thought of innovative methods 
...
such as greenhouse gas emissions and eutrophication.

Both China and Norway are big fishing nations, but their fisheries development methods are very different. But in general, 
Norway's overexploited fishing rate is much lower than China's. Therefore, we want to find ways of sustainable fishing by 
comparing these two countries and find out where China's unsustainable fishing activities are. More interestingly, 
we found the advantage of seafood as a protein intake, and to maximize this advantage, sustainable fishing activities become more important.
                                 """),
             ]),
    #######################################################################
    ###                      GDP and Consumption                       ####
...
Indeed the graph shows us the relationship between per capita seafood consumption and average GDP per capita. What we can see from it is that 
they are strongly positively correlated. The more money people earn, the more seafood they eat. 
...
of just fulfilling their basic needs. As a result, they are now more concerned about dietary health and nutritional intake, which will cause the 
demand for protein foods, such as fish and meat to continue growing. Seeing as how we are already unable to supply the world's demand for protein 
products and rely on overexploiting marine life and are increasing global greenhouse gas (GHG) emissions, how will we facilitate this growth? 
...
The bar chart also shows us that fish and seafood create the least GHG emissions for the same amount of protein, therefore being a better way to get enough nutrition sustainably. More seafood also has other benefits apart from being more environmentally friendly.
"""),
             ]),
...
We can see in the graph that Chinese people intake protein mainly from pork and seafood while Norwegian people prefer milk and seafood, where seafood accounts for around 24% of protein consumption in both countries. Showing us that people in China and Norway have similar seafood protein intake habits.
However interestingly, since we've already established that Chinese people eat less fish per capita, that also means that at the moment they eat less protein overall. 

So we've established that fish is arguably the better protein source with a relatively low amount of GHG emissions. That still doesn't address the fact the current trend of overfishing is unsustainable. One major factor in that is the ineffective current fishing practices.
...
Unfortunately, China plays a big role in the fishing industry, which we can't do without. And It's safe to say that the methods they use need improvements, however, there is one more fishing industry that we haven't discussed yet, aquaculture.
        """),
        ]),
...
The growing issue of overfishing has allowed the rapid growth of the aquaculture, or fish farming, industry over the last decades as can be seen in the figures. Fish produced from farming activities currently accounts for over one-quarter of all fish directly consumed by humans. 

Many people believe that aquaculture will replace a large part of wild capture production over the next decades. And that it will be able to reduce pressure on ocean harvests to allow the fish population to recover. However in reality the industry is not as efficient as it seems and the industry will have to change if it ever wants to fulfil this role. 

To begin with, a large part of the aquaculture production is carnivorous fish species, such as salmon, that require 2 to 5
times more fish protein, in the form of fish meal made from scrap fish products, to feed the farmed species than is supplied by the farmed product. And a lot of this protein originates from wild captured fish, which as you can imagine is counter-productive. Even herbivorous and omnivorous freshwater fish that require minimal quantities of a fish meal is fed with about 15% fish meal, exceeding the required levels.
...
- aquaculture is a lot more at risk from outside threads than the fishing industry. For example, in 2010 aquaculture production in China suffered losses of 1.7 million tonnes (worth US$3.3 thousand million) due to disease outbreaks (295 thousand tonnes), natural disasters (1.2 million tonnes), and pollution (123 thousand tonnes) (FAO 2012).

Currently, China produces around two-thirds of the global aquaculture production, with the common carp, an omnivorous, as its biggest product. Whilst Norway's most farmed fish is the Atlantic salmon, a carnivore. Should China solve its inefficient practices its aquaculture industry should be able to thrive and result in a greater global (net) fish supply.

So far we're only talked about the negatives, so let's shine some light on one major benefit that aquaculture has over capture production. 
...
We've already established that fish and other aquatic foods (blue foods) are an effective way of reaching a sustainable diet. As the graph shows GHG emissions, as well as other environmental stressors, of most blue food groups, compare favourably to industrial chicken production, which typically has lower stressors than other livestock as we've seen in a previous figure. However, this holds for both aquaculture captures as well as capture fisheries. Although generally farmed fish produce a lower or equal average emission than their captured counterpart.

Most of the emissions of aquaculture result from growing fish food, whereas in the capture fisheries fuel causes the most emission. For fed systems, 87% of N and 94% of P occur on food farms. This also means that non-fed groups such as seaweeds and bivalve remove more N and P than is emitted during production. 

However since aquaculture uses the land for both the fish and food farms, this creates trade-offs with alternate uses, including the production of other foods. And since the availability and access to freshwater increasingly constraints the agriculture industry, this creates a downside to fed systems where freshwater is largely used in feed production, whereas capture fisheries and unfed systems require little freshwater.

As it turns out although farmed fish does not appear to have a major environmental benefit, compared to captured fish, at the moment it is also safe to say that the industry has not nearly reached its full potential. It's still a young and rapidly growing sector with many promising technologies and policies to improve its efficiency. Where the main problem to tackle while expanding is making sure new inventions are not beyond the reach of the many small producers.
